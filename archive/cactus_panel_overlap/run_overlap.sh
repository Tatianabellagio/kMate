...
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/cactus_panel_overlap/logs/cactus_overlap_%j.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/cactus_panel_overlap/logs/cactus_overlap_%j.err
#SBATCH --nodes=1
...
BASE=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/cactus_panel_overlap
DATA=$BASE/data
...
XWU_VCF=/carnegie/nobackup/scratch/xwu/GrENE_net/hapFIRE_updatedVCF/greneNet_final_v1.1.recode.vcf
XWU_BGZ=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/imputation/work/grene_all.vcf.gz

CACTUS_VCF=/home/tbellagio/scratch/pang/pang_1001gplus/pang/output/pang_1001gplus_82acc.vcf.gz
...
python3 <<'PYEOF'
import os
DATA = "/carnegie/nobackup/scratch/tbellagio/hapfire_sv/cactus_panel_overlap/data"
