...
#SBATCH --output=logs/extract_v3_%j.out
#SBATCH --error=logs/extract_v3_%j.err
# =============================================================================
...
BCF=/global/home/users/tbellg/miniforge3/envs/BIOS424/bin/bcftools

BASE=/global/scratch/users/tbellg/hapfire_sv/panel_overlap_v3_grenenet
DATA=$BASE/data
V3_VCF=/global/scratch/users/tbellg/hapfire_sv/pangenie_genotyping/data/merged/founders_231_chr.haploid.vcf.gz
