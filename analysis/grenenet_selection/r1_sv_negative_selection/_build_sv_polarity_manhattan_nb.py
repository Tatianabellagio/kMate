...
OUT = f"{ROOT}/analysis/grenenet_selection/notebooks/sv_polarity_enrichment_clq90.ipynb"
...
WZA = f"{GEA}/r2_gea_nonsnp/phase1_replication/results/clq90/wza"
...
comp = pd.read_csv(f"{GEA}/extras/driver_passenger/results/block_composition_kendall_gen9_bio1.csv")
pol = pd.read_csv(f"{GEA}/r2_gea_nonsnp/phase1_replication/results/clq90/block_polarity_composition.csv")
...
out = f"{GEA}/r2_gea_nonsnp/phase1_replication/results/clq90/manhattan_sv_polarity_clq90.png"
