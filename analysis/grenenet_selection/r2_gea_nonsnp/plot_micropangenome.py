...
Bottom: the Minigraph-Cactus bubble at Chr3:18,895,050 as a sequence graph — the
  ...
  $PY analysis/grenenet_selection/r2_gea_nonsnp/plot_micropangenome.py
...
FIGDIR = "/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/results/figures"
