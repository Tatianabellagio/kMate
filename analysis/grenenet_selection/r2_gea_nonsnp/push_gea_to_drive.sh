...
#
# Run (survives logout):
#   nohup bash analysis/grenenet_selection/r2_gea_nonsnp/push_gea_to_drive.sh > /tmp/gea_push.log 2>&1 &
...
WZA="$PROJ/analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/wza"
P1="$PROJ/analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results"
