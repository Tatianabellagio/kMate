...
Implements analysis/grenenet_selection/archive/PIPELINE_B_POOLED_MODEL.md exactly:
...
significant-blocks work unchanged) + printed diagnostics.
  ...
  $PY analysis/grenenet_selection/r2_gea_nonsnp/build_two_stage_pooled.py --climate bio1
"""
