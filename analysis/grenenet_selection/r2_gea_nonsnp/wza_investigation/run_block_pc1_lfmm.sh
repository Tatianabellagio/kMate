...
#SBATCH --mem=96G
#SBATCH --time=4:00:00
#SBATCH --output=/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/pc1_lfmm_%j.out
#SBATCH --error=/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/pc1_lfmm_%j.out
set -euo pipefail
cd /global/scratch/users/tbellg/kmate
PY=/global/home/users/tbellg/miniforge3/envs/kmate/bin/python
R=/global/home/users/tbellg/miniforge3/envs/lfmm_env/bin/Rscript
PR=analysis/grenenet_selection/wza_investigation                  # PC1 scripts now live here
P1R=analysis/grenenet_selection/phase1_replication                # run_lfmm_lastgen.R stays in the replication
PCDIR=/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/results/pc1
K=16
...
cls=sys.argv[1]; PCDIR="analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/results/pc1"
...
PCDIR="analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/results/pc1"; WZ="analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/wza"
