...
#SBATCH --mem=64G
#SBATCH --time=3:00:00
#SBATCH --output=/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/block_pc1_%j.out
#SBATCH --error=/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/block_pc1_%j.out
set -euo pipefail
...
PC="analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/results/pc1"            # PC1 outputs (relocated)
