...
blocks under deg-2. CAM5 (block 2_1265) starred.
  ...
  $BPY analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/_build_manhattan_nb.py
"""
import os
...
fig.tight_layout()
OUT_PNG = "/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/results/fig9_manhattan_cap_vs_nocap.png"
