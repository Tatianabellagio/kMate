...
once SNP-count and site pseudo-replication are accounted for (0 blocks pass BH).
  ...
  $BPY analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/_build_pc1_manhattan_nb.py
"""
import os
...
RES = "/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/results"
