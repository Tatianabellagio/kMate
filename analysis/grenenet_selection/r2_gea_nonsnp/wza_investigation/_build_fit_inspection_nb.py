...
OUT = f"{ROOT}/analysis/grenenet_selection/r2_gea_nonsnp/wza_investigation/fit_inspection_{MODEL}.ipynb"
...
os.chdir("__ROOT__")
MA = "analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/multiaxis"
ROLLER, MINE = 50, 40
