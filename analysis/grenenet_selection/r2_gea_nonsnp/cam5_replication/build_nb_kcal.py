...
LFMM = "/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/lfmm"
...
cells.append(nbf.v4.new_code_cell(
'''import os
KS = "/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/r2_gea_nonsnp/cam5_replication/results/ksweep_gif_snp_gen9_bio1.csv"
