...
COMPOSITION = f"{lib.GEA}/extras/driver_passenger/results/block_composition_kendall_gen9_bio1.csv"
POLARITY = f"{lib.GEA}/r2_gea_nonsnp/phase1_replication/results/clq90/block_polarity_composition.csv"
OUT = f"{lib.GEA}/r2_gea_nonsnp/phase1_replication/results/clq90/sv_polarity_enrichment_clq90.csv"
