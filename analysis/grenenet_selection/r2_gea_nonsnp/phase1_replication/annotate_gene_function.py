...
Outputs (analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/):
  ...
  $PY analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/annotate_gene_function.py
"""
