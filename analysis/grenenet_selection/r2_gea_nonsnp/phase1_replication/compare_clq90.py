...
def main():
    ...
    ap.add_argument("--wza", default=f"{lib.GEA}/r2_gea_nonsnp/phase1_replication/results/clq90/wza")
    ...
    ap.add_argument("--out", default=f"{lib.GEA}/r2_gea_nonsnp/phase1_replication/results/clq90/compare_clq90.csv")
    args = ap.parse_args()
