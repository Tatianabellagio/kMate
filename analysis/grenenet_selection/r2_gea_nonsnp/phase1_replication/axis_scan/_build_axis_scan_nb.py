...
C.append(new_code_cell(
    ...
    "sys.path.insert(0, f'{PROJ}/analysis/grenenet_selection')\n"
    "sys.path.insert(0, f'{PROJ}/analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/axis_scan')\n"
    ...
    f"PCOL='{PCOL}'; TAG='{TAG}'\n"
    "POW=f'{PROJ}/analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/power'\n"
    "SITE=f'{PROJ}/analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/lfmm_site'\n"
    "CM=f'{PROJ}/analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/class_matrices'\n"
    "OUT=f'{PROJ}/analysis/grenenet_selection/r2_gea_nonsnp/phase1_replication/results/axis_scan'; os.makedirs(OUT,exist_ok=True)\n"
