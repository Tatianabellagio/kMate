...
- kMate per-sample AF: `analysis/grenenet_selection/common/rerun_kfw_hb/{seedmix,evolved}/`
...
- derived outputs → `analysis/grenenet_selection/` (large, gitignored; rebuildable).
