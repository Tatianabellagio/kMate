...
blocks under deg-2. CAM5 (block 2_1265) starred.
  ...
  $BPY analysis/grenenet_selection/wza/investigation/_build_manhattan_nb.py
"""
import os
...
OUT = f"/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/notebooks/wza_manhattan_cap_vs_nocap.ipynb"
...
sys.path.insert(0, "/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/wza/investigation")
