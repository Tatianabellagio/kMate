...
once SNP-count and site pseudo-replication are accounted for (0 blocks pass BH).
  ...
  $BPY analysis/grenenet_selection/wza/investigation/_build_pc1_manhattan_nb.py
"""
import os
...
OUT = f"/global/scratch/users/tbellg/kmate/analysis/grenenet_selection/notebooks/pc1_manhattan.ipynb"
