...
# Rebuild analysis/grenenet_selection/common/results/gen_matrices/ from the on-cluster af_store.
...
#
# Usage:
#   sbatch --array=1-9%9 analysis/grenenet_selection/common/build_gen_matrices_array.sh
#
...
mkdir -p logs analysis/grenenet_selection/common/results/gen_matrices
...
$PY -u analysis/grenenet_selection/common/build_gen_matrices.py --gens "$GEN" --kinds "$KIND"
