...
analysis/grenenet_selection/common/results/fitness/sample_genome_h.npz  ->  samples (str[N]), H (N x 231), founders.
...
WIN = lib.OUT
OUT = "analysis/grenenet_selection/common/results/fitness"
