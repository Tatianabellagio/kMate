...
→ `analysis/grenenet_selection/archive/window_hapfreq_retired/window_vs_global/` (SUMMARY.txt, plot).
...
`analysis/grenenet_selection/archive/window_hapfreq_retired/gen9_window/` (build_gather_index → extract_sample → merge_pools →
