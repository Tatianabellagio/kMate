...
Input  : analysis/grenenet_selection/blocks_mcf90/chr{N}_clq0.9_blocks_clq0.9.tsv
Output : analysis/grenenet_selection/blocks_mcf90/coarse/chr{N}_floor{F}.tsv  (chrom start end n_variants n_merged)
