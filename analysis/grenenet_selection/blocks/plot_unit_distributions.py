...
D = pd.read_csv("analysis/grenenet_selection/blocks_mcf90/final_units_dynld_K500_metrics.csv")
...
plt.suptitle(f"Final dynamic-LD units (K=500), n={len(D):,}  |  covered {int(D.covered.sum()):,} ({100*D.covered.mean():.0f}%)",
             fontsize=13)
plt.tight_layout(); plt.savefig("analysis/grenenet_selection/blocks_mcf90/unit_distributions.png", dpi=110)
print("wrote analysis/grenenet_selection/blocks_mcf90/unit_distributions.png")
