...
CSV = f"{ROOT}/analysis/grenenet_selection/blocks/results/blocks_recompute/chr1_pc1ve_by_clqcut.csv"
OUT = f"{ROOT}/analysis/grenenet_selection/notebooks/block_coherence_clqcut.ipynb"
...
MD90 = "{ROOT}/analysis/grenenet_selection/blocks/results/blocks_mcf90"
_p=[]
...
cells.append(new_code_cell(
f"""BR = "{ROOT}/analysis/grenenet_selection/blocks/results/blocks_mcf90"   # NON-MISSING (min-called-frac 0.9) Chr1 map
...
cells.append(new_code_cell(
f"""_fv = "{ROOT}/analysis/grenenet_selection/blocks/results/blocks_mcf90/chr1_clq0.9_founder_vs_evolved_ve.csv"  # NON-MISSING map
...
cells.append(new_code_cell(
f"""import glob
_tf = sorted(glob.glob("{ROOT}/analysis/grenenet_selection/blocks/results/blocks_recompute/chr*_panel_support_tag.csv"))
...
cells.append(new_code_cell(
f"""import glob
_msf = sorted(glob.glob("{ROOT}/analysis/grenenet_selection/blocks/results/blocks_recompute/chr*_missing_sensitivity.csv"))
if not _msf:
...
cells.append(new_code_cell(
f"""MD = "{ROOT}/analysis/grenenet_selection/blocks/results/blocks_mcf90"
