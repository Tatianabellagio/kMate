...
OUT = f"{ROOT}/analysis/grenenet_selection/qc/seedmix_validation/fix_seedmix"
...
sys.path.insert(0, f"{ROOT}/analysis/grenenet_selection/qc/seedmix_validation/fix_norm")
...
def main():
    ...
    import csv
    hapmap, expmap = {}, {}
    with open(f"{ROOT}/analysis/grenenet_selection/qc/seedmix_validation/seedmix_kmate_vs_hapfire_ordered.csv") as fh:
