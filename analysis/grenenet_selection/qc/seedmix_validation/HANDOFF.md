...
4. Then revisit the downstream GEA: `analysis/grenenet_selection/r3_persite_gwas/build_selection_trait.py` still drops to
...
- Genomic control REMOVED (raw kinship-corrected z) from `analysis/grenenet_selection/r3_persite_gwas/class_split_gwas.py`
