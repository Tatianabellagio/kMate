...
OUT = f"{ROOT}/analysis/grenenet_selection/qc/seedmix_validation/fix_kfw_fullpanel"
CDIR = f"{ROOT}/analysis/grenenet_selection/qc/seedmix_validation/fix_seedmix/counts"
PANEL = f"{ROOT}/data/kmer_pa_231_arch3_filt2inv/kmer_pa_Chr1"
BLOCKTSV = f"{ROOT}/analysis/grenenet_selection/blocks/hap_blocks/ld_blocks_r2_0.10.tsv"
CHROM = "Chr1"
F = 231
