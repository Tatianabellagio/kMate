...
Inputs (all cached, light):
  - analysis/grenenet_gea/fitness/sample_genome_h.npz   (build_sample_h_cache.py)
  - analysis/grenenet_gea/archive/window_hapfreq_retired/hapfreq/cross_site_S_matrix_gen1.npz  (per-site s_f, 30 sites)
  - /global/home/users/tbellg/scratch/grene/data/survival.csv
  - lib.pool_table()  (sampleid -> site,plot,generation,flowerscollected)

Outputs: analysis/grenenet_gea/fitness/{plot_fitness_composition.csv, plot_h.npz, stepA_summary.json}
Env: kmate.
"""
import os, sys, json
import numpy as np
...
FIT = "analysis/grenenet_gea/fitness"
