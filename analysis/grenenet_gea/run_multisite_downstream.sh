...
$KPY analysis/grenenet_gea/cross_site_winners_multisite.py
echo "[$(date)] 2/3 climate permutation null (kmate)"
$KPY analysis/grenenet_gea/multisite_climate_perm.py
echo "[$(date)] 3/3 notebook (basic)"
$BPY analysis/grenenet_gea/_build_multisite_gwas_nb.py
