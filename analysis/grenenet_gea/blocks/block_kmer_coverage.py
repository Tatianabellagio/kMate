...
Output: analysis/grenenet_gea/blocks_mcf90/chr1_block_kmer_coverage.csv
"""
...
def main():
    ...
    b["status"] = st
    b.to_csv("analysis/grenenet_gea/blocks_mcf90/chr1_block_kmer_coverage.csv", index=False)
