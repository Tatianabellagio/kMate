...
PYTHONPATH=analysis/grenenet_gea."""
...
bl = pd.read_csv("analysis/grenenet_gea/blocks_recompute/chr1_clq0.9_blocks_clq0.9.tsv", sep="\t")
fves = []
...
ev = pd.read_csv("analysis/grenenet_gea/blocks_recompute/chr1_pc1ve_by_clqcut.csv")
...
m.to_csv("analysis/grenenet_gea/blocks_recompute/chr1_clq0.9_founder_vs_evolved_ve.csv", index=False)
