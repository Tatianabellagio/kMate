...
For each dynld-K500 unit (results/grenenet_gea/blocks_mcf90/chr{N}_units_dynld_K500.tsv),
...
Output per chrom: results/grenenet_gea/blocks_mcf90/hap_membership/{chrlc}_hapmemb_K500.npz
