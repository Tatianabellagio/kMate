...
#   $PY analysis/grenenet_gea/common/build_af_store.py init --out-dir analysis/grenenet_gea/af_store
#   N=$($PY -c "import json;print(json.load(open('analysis/grenenet_gea/af_store/meta.json'))['n_samples'])")
#   CHUNK=70; NT=$(( (N + CHUNK - 1) / CHUNK ))
#   sbatch --array=1-${NT}%32 --export=ALL,OUT_DIR=analysis/grenenet_gea/af_store,CHUNK=$CHUNK \
#     analysis/grenenet_gea/common/build_af_store_array.sh
...
$PY -u analysis/grenenet_gea/common/build_af_store.py convert \
