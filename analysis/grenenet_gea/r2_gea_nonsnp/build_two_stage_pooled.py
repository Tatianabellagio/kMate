...
Implements analysis/grenenet_gea/archive/PIPELINE_B_POOLED_MODEL.md exactly:
...
significant-blocks work unchanged) + printed diagnostics.
  ...
  $PY analysis/grenenet_gea/r2_gea_nonsnp/build_two_stage_pooled.py --climate bio1
"""
