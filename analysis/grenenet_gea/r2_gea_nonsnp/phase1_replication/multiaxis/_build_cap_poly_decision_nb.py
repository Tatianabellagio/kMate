...
OUT = f"{ROOT}/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/notebooks/cap_poly_decision.ipynb"
...
os.chdir("__ROOT__")
MA = "analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/multiaxis"
