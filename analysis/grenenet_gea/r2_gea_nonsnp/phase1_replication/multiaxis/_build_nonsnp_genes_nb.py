...
and a functional-category tagging (heat / drought-ABA / cold / flowering-circadian).
  ...
  $BPY analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/multiaxis/_build_nonsnp_genes_nb.py
"""
import os
...
CSV = "/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/multiaxis/nonsnp_specific_genes.csv"
d = pd.read_csv(CSV)
...
full.to_csv("/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/"
