...
Output (analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/clq90/):
  ...
  $PY analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/build_significant_genes_clq90.py --fdr 0.05
"""
