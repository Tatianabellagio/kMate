...
visible directly at the source, plus a WZA-level summary table for reference.
  ...
  $BPY analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/_build_binomial_fix_compare_nb.py
"""
import os
...
OUT = f"{OUTDIR}/binomial_fix_compare.ipynb"
...
CLQ = "/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/clq90"
