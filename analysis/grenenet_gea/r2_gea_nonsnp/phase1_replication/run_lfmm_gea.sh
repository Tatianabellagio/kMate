...
#SBATCH --output=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/lastgen_lfmm_%j.out
#SBATCH --error=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/lastgen_lfmm_%j.out
set -euo pipefail
...
LDIR=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/lfmm
...
CMDIR=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/class_matrices
mkdir -p "$LDIR" "$WDIR"
K=16
...
cls=sys.argv[1]
CMDIR="analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/class_matrices"
LDIR="analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/lfmm"
KDIR="analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/kendall"
