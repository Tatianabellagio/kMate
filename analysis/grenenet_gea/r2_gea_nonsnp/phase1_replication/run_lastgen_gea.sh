...
#SBATCH --mem=96G
#SBATCH --time=4:00:00
#SBATCH --output=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/lastgen_gea_%j.out
#SBATCH --error=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/lastgen_gea_%j.out
set -euo pipefail
cd /global/scratch/users/tbellg/kmate
PY=/global/home/users/tbellg/miniforge3/envs/kmate/bin/python
PR=analysis/grenenet_gea/phase1_replication
WZA=analysis/grenenet_gea/r2_gea_nonsnp/wza_script.py
KEN=analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/kendall/kendall_snp_gen9_bio1.csv
WDIR=analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/wza
