...
Output (analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/):
  ...
  $PY analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/build_significant_genes.py --fdr 0.05
"""
