...
clq90/compare_clq90.csv (frozen production). Writes only to:
  analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/clq90/kendall_fix_test/site_collapsed/

Usage:
  PY=/global/home/users/tbellg/miniforge3/envs/kmate/bin/python
  $PY analysis/grenenet_gea/r2_gea_nonsnp/_kendall_site_collapsed_test.py
"""
