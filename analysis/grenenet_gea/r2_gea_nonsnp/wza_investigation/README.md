...
Tested empirically — see `analysis/grenenet_gea/r2_gea_nonsnp/wza_investigation/results/`
...
- `run_investigation.py` — gen1 SNP×bio1: sweeps degree {2,7} × cap {none, 2000,
  ...
  the low-SNP-overweighting test. Outputs → `analysis/grenenet_gea/r2_gea_nonsnp/wza_investigation/results/`.
