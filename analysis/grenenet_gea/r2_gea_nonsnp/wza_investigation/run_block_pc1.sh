...
#SBATCH --mem=64G
#SBATCH --time=3:00:00
#SBATCH --output=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/wza_investigation/block_pc1_%j.out
#SBATCH --error=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/r2_gea_nonsnp/wza_investigation/block_pc1_%j.out
set -euo pipefail
...
PC="analysis/grenenet_gea/r2_gea_nonsnp/wza_investigation/results/pc1"            # PC1 outputs (relocated)
WZ="analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/wza"           # WZA inputs from the replication
def wza(cls):
