...
#SBATCH --mem=192G
#SBATCH --time=8:00:00
#SBATCH --output=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/kscan_%j.out
#SBATCH --error=/global/scratch/users/tbellg/kmate/analysis/grenenet_gea/kscan_%j.out
set -euo pipefail
...
for K in 1 2 3 4 5 6 7 8; do
  echo "=== K=$K ==="
  $R run_lfmm.R "$DP" "$ENV" "$K" "$L/kscan_bio1_k${K}"
done
echo DONE_KSCAN
