...
`analysis/grenenet_gea/r3_persite_gwas/build_tagging_masked.py` docstring for the full story):
...
This notebook uses the corrected data (`analysis/grenenet_gea/sv_snp_ld_v2/`,
...
{panel, shortread}.
  ...
  $BPY analysis/grenenet_gea/r3_persite_gwas/_build_tagging_masked_nb.py
"""
import os
...
masking. Fixed in `analysis/grenenet_gea/r3_persite_gwas/build_tagging_masked.py`: proper
