...
x 2 modes = 20 calls, ~shared loads if run per-chrom):
  ...
  $PY analysis/grenenet_gea/r3_persite_gwas/build_tagging_masked.py --chrom Chr1 \
...
SR_GENO = f"{PROJ}/analysis/grenenet_gea/sv_snp_ld/shortread_geno_{{Cl}}.npz"
OUTDIR = f"{PROJ}/analysis/grenenet_gea/sv_snp_ld_v2"
