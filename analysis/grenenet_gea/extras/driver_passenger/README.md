...
`analysis/grenenet_gea/extras/driver_passenger/results/`.
...
- Per-class gen9 kendall: `analysis/grenenet_gea/r2_gea_nonsnp/phase1_replication/results/kendall/kendall_{snp,sv,smallindel}_gen9_bio1.csv`
