...
Output -> results/grenenet_gea/varexp/gwas_plots/{multitrait,persite}_{class}_{name}_{manhattan,qq}.png
...
OUT = "/global/scratch/users/tbellg/kmate/results/grenenet_gea/varexp"
