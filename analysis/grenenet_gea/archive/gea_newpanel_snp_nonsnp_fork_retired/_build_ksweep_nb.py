...
C.append(new_code_cell(
    ...
    f"K='{K}'\n"
    "RAWP=f'{PROJ}/analysis/grenenet_gea/gea_newpanel/results/ksweep_calib/raw_p'\n"
    "SITE=f'{PROJ}/analysis/grenenet_gea/gea_newpanel/results/lfmm_site'\n"
    "CM=f'{PROJ}/analysis/grenenet_gea/phase1_replication/results/class_matrices'\n"
    "OUT=f'{PROJ}/analysis/grenenet_gea/gea_newpanel/results/snp_vs_nonsnp'; os.makedirs(OUT,exist_ok=True)\n"
