...
Data
  performance  S[f,site] = per-founder selection = mean-over-plots logit-slope of the founder's
    ...
    Smat). Cached to analysis/grenenet_gea/archive/window_hapfreq_retired/hapfreq/cross_site_S_matrix.npz (heavy Lustre I/O; build
...
Writes analysis/grenenet_gea/archive/window_hapfreq_retired/hapfreq/predict_ecotype_performance.{csv,json,png}. Env: kmate.
"""
