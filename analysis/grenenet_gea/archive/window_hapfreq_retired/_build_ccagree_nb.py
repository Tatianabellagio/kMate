...
H = "analysis/grenenet_gea/archive/window_hapfreq_retired/hapfreq"; CHROMS = ["Chr1","Chr2","Chr3","Chr4","Chr5"]
...
g0 seed-mix pools); table `analysis/grenenet_gea/archive/window_hapfreq_retired/hapfreq/cross_chrom_agreement_full.csv`.*"""
