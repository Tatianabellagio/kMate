...
then assembles the plots.
  ...
  $BPY analysis/grenenet_gea/qc/_build_support_nb.py
"""
import os, glob
...
OUTBASE = f"{PROJ}/analysis/grenenet_gea/common/rerun_kfw_hb/evolved"  # repointed 2026-07-07 (full-panel-Kf_w + --unit chrom rerun)
