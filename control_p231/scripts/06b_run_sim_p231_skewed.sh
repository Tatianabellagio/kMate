...
# individual (ind001 gets DOMINANT_FRAC% of pool reads). Mirrors control_p80
...
WORK=$CTRL/sims/cov${COVERAGE}_n${N_INDIV}_g${N_GEN}_s${SEED}_hotspots_${DOM_TAG}_p231_chr1
