# `control_p231/` — 231-founder benchmark (paper headline)
...
`control_p80/` (the all-long-read homogeneous control that isolates the panel-
...
## Key design choices vs control_p80
...
## Regimes (match control_p80, cov10, seed 42, Chr1)
