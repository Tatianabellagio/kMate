...
| `INVESTIGATION_CN_VAR_DECOMPOSITION.md` | Why production switched to the arch decomposition (annotate_vcf + convert-to-biallelic) instead of `bcftools norm -m -any` for cn_var. |
