...
output (kmer_index/pang_135_diploid/) against the canonical PG-index output
already on disk (pangenie_genotyping/data/pang_135_pangenie_index_Chr{1..5}_kmers.tsv.gz,
