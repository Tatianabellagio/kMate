...
#SBATCH --mem=80G
#SBATCH --time=8:00:00
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/kmer_index/logs/pang_135_haploid_%j.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/kmer_index/logs/pang_135_haploid_%j.err
set -euo pipefail
