...
set -uo pipefail
mkdir -p /global/scratch/users/tbellg/kmate/scripts/logs
mkdir -p /global/scratch/users/tbellg/kmate/results/site04_hapfire_perblock_h
mkdir -p /global/scratch/users/tbellg/kmate/results/site04_hapfire_perblock_proj
