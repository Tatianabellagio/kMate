...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=logs/cn_full_v3_%A_%a.out
#SBATCH --error=logs/cn_full_v3_%A_%a.err
...
# (src/build_kmer_cn.py) with the new haploid VCF as input.
...
OUT_DIR=$BASE/data/cn_full_231_v3
