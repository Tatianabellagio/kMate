...
# One-time job per panel; produces data/block_haplotype_cn/chr1_full.npz.
mkdir -p logs
set -uo pipefail
...
$PYTHON -u scripts/build_block_haplotype_cn.py \
    ...
    --out data/block_haplotype_cn/chr1_full.npz \
    --chrom-filter Chr1 --threads 8

echo "[$(date)] DONE"
ls -lh data/block_haplotype_cn/chr1_full.npz
