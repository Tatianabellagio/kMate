...
SRC_DIR = Path('/global/scratch/users/tbellg/kmate/data/cn_full_231_v3qc_v2')
OUT_DIR = Path('/global/scratch/users/tbellg/kmate/data/cn_full_231_v3qc_v2_rownorm')
...
EOF
echo "[$(date)] DONE"
ls -lh /global/scratch/users/tbellg/kmate/data/cn_full_231_v3qc_v2_rownorm/
