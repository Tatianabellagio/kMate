...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=logs/kmer_pa_v3qc_v3_Noff_diag_%j.out
#SBATCH --error=logs/kmer_pa_v3qc_v3_Noff_diag_%j.err
#
# ============================ DIAGNOSTIC ONLY ============================
# This is NOT a production build. Production kmer_pa_v3qc_v3 is N-ON
...
#
# This build is N-OFF (./.->REF, the build_kmer_pa.py default) for ONE purpose:
...
# Delete data/kmer_pa_231_v3qc_v3_Noff_diag/ once the question is answered.
# ========================================================================
mkdir -p logs
set -euo pipefail
...
OUT_DIR=$BASE/data/kmer_pa_231_v3qc_v3_Noff_diag
mkdir -p $OUT_DIR
...
echo "[$(date)] $CHR kmer_pa v3qc_v3 N-OFF DIAGNOSTIC (./. -> REF; NO --treat-missing-as-n)"
