...
SRC = Path('/global/scratch/users/tbellg/kmate/data/cn_full_231_v3qc_v2')
OUT = Path('/global/scratch/users/tbellg/kmate/data/cn_full_231_v3qc_v2_filt2_rownorm')
...
echo "[$(date)] DONE"
ls -lh /global/scratch/users/tbellg/kmate/data/cn_full_231_v3qc_v2_filt2_rownorm/
