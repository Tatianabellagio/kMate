...
#SBATCH --mem=4G
#SBATCH --time=4:00:00
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/preprocess_qc/logs/qc_%A_%a.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/preprocess_qc/logs/qc_%A_%a.err
...
BASE=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/preprocess_qc
