...
- **Production cn matrices**: cn_var — `arch3/chr1/cn_var_231_arch3_chr1.{cn_var,cn_var_called,meta}.npz` (Arch 3). **cn_full is the OPEN k-mer-filter decision** — many candidate builds under `poolfreq/data/cn_full_231_v3qc_v3*` (raw, `_filt2`, `_mixedloose` [deprecated], `_subsampMedian_refilt2`, `_subsampProtect{1,2}_refilt2`, …) under active test (2026-05-26); see `PIPELINE_STATE_2026-05-22.md` §1/§3. Earlier `cn_full_231_v3`, `cn_var_231_v3` etc. are *(archive)*.
