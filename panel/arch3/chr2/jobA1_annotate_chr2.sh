...
# Phase 2 Job A1: run annotate_vcf on FULL Chr2 (135-sample input).
# Produces the annotated multi-allelic VCF + biallelic catalog for Chr2.
...
REGION="Chr2"   # full Chr2
OUTPREFIX=chr2_135_annotated

echo "[$(date)] === Step 1: subset 135-sample VCF to full Chr2 ==="
VCF_CHR1=chr2_135.vcf
...
echo
echo "[$(date)] DONE A1 (annotate Chr2)"
