...
# Phase 2 Job A1: run annotate_vcf on FULL Chr5 (135-sample input).
# Produces the annotated multi-allelic VCF + biallelic catalog for Chr5.
...
REGION="Chr5"   # full Chr5
OUTPREFIX=chr5_135_annotated

echo "[$(date)] === Step 1: subset 135-sample VCF to full Chr5 ==="
VCF_CHR1=chr5_135.vcf
...
echo
echo "[$(date)] DONE A1 (annotate Chr5)"
