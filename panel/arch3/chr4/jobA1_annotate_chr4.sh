...
# Phase 2 Job A1: run annotate_vcf on FULL Chr4 (135-sample input).
# Produces the annotated multi-allelic VCF + biallelic catalog for Chr4.
...
REGION="Chr4"   # full Chr4
OUTPREFIX=chr4_135_annotated

echo "[$(date)] === Step 1: subset 135-sample VCF to full Chr4 ==="
VCF_CHR1=chr4_135.vcf
...
echo
echo "[$(date)] DONE A1 (annotate Chr4)"
