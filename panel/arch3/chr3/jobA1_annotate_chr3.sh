...
# Phase 2 Job A1: run annotate_vcf on FULL Chr3 (135-sample input).
# Produces the annotated multi-allelic VCF + biallelic catalog for Chr3.
...
REGION="Chr3"   # full Chr3
OUTPREFIX=chr3_135_annotated

echo "[$(date)] === Step 1: subset 135-sample VCF to full Chr3 ==="
VCF_CHR1=chr3_135.vcf
...
echo
echo "[$(date)] DONE A1 (annotate Chr3)"
