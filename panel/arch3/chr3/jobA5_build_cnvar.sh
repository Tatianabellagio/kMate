...
# Phase 2 Job A5: build var_pa matrices from the NEW Chr3 merged panel.
# Outputs: var_pa_231_arch3_chr3.{var_pa,var_called,meta}.npz
...
VCF=merged_231_chr3_final.vcf.gz
OUT_PREFIX=var_pa_231_arch3_chr3

[ -s "$VCF" ] || { echo "ERROR: missing $VCF (A4 not done)"; exit 1; }

echo "[$(date)] === build_var_pa on Chr3 merged panel ==="
