...
BASE=/global/scratch/users/tbellg/kmate/panel/pangenie_genotyping/data/v3qc_v2
OUT=/global/scratch/users/tbellg/kmate/panel/pangenie_genotyping/data/v3qc_v2/missingness_report
