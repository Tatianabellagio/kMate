...
# panel/pangenie_genotyping/data/pang_135_pangenie_index_Chr{1..5}_kmers.tsv.gz.
...
VCF=/global/scratch/users/tbellg/kmate/panel/pangenie_genotyping/data/pang_1001gplus_all.dipl.vcf.gz
