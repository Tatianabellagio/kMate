...
# SELF = optional selfing tag inserted between seed and the SUBDIR_TAG, matching
# the _self<pct> dir tag emitted by 06_run_sim_p80.sh for the selfing regimes.
SELF=""
case "$REGIME" in
    ...
    n50_g3_dom500nr) N_INDIV=50; N_GEN=3; SUBDIR_TAG="hotspots_dom500nr_p80_chr1" ;;
