...
# =============================================================================
# benchmarks/p231 Phase A5 -- per-founder consensus FASTAs from the ARCH3 canonical
# 231 VCF (merged_231_chr1_final.vcf.gz). Mirrors benchmarks/p80/05_build_fastas_p80.sh.
#
