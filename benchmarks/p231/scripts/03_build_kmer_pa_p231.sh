...
# =============================================================================
# benchmarks/p231 Phase A3 -- kmer_pa k-mer index from the ARCH3 canonical VCF
# (merged_231_chr1_final.vcf.gz), for single-source provenance.
#
# Identical recipe to scripts/build_kmer_pa_v3qc_v3_chr1.sh EXCEPT
...
# topology), same ref, same --treat-missing-as-n. kmer_pa is consensus-derived so
# this should reproduce the production kmer_pa nearly exactly (validated by
...
OUT_DIR=$BASE/benchmarks/p231/data/kmer_pa_p231
mkdir -p $OUT_DIR
...
echo "[$(date)] $CHR kmer_pa p231 from arch3 merged_231 (--treat-missing-as-n)"
