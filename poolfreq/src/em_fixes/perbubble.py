...
This mirrors poolfreq/src/em_solver.py (solve_em) and the densify / nz-filter /
cov-scalar handling in poolfreq/src/archive/sweep_shape_norm_h_only.py, just with
