...
the STANDARD UNWEIGHTED EM (mirror poolfreq/src/em_solver.solve_em and the
densify / nz-filter / cov-scalar handling of
poolfreq/src/archive/sweep_shape_norm_h_only.py) on the kept-column subset, using
