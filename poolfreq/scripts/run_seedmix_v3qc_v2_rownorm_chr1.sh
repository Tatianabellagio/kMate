...
#SBATCH --mem=80G
#SBATCH --time=2:00:00
#SBATCH --output=logs/sm_rownorm_%j.out
#SBATCH --error=logs/sm_rownorm_%j.err
...
OUT_DIR=/global/scratch/users/tbellg/hapfire_sv/scratch/seedmix_v3qc_v2_rownorm_test
mkdir -p $OUT_DIR
