...
# Wraps poolfreq/src/build_cn_var.py — the existing builder handles haploid
# GTs correctly (any-non-zero-allele = carrier).
#
# Output:
#   poolfreq/data/cn_var_231_v3.cn_var.npz   (CSR, 231 × N_records int8 binary)
#   poolfreq/data/cn_var_231_v3.meta.npz     (founders, chrom, pos, ref_len, alt_len)
#
...
OUT_PREFIX=$BASE/poolfreq/data/cn_var_231_v3
