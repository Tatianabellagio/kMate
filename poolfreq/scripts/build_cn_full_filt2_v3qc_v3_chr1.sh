#!/bin/bash
#SBATCH --job-name=filt2_v3
#SBATCH --partition=bse
#SBATCH --cpus-per-task=2
#SBATCH --mem=48G
#SBATCH --time=1:00:00
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/logs/filt2_v3_%j.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/logs/filt2_v3_%j.err
...
OUT_DIR=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/data/cn_full_231_v3qc_v3_filt2
mkdir -p $OUT_DIR
