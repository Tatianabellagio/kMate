...
#SBATCH --mem=48G
#SBATCH --time=1:00:00
#SBATCH --output=logs/mixloose_v3_%j.out
#SBATCH --error=logs/mixloose_v3_%j.err
# Subset cn_full_v3qc_v3 to k-mers carried by ≥1 cactus + ≥1 PG founder.
mkdir -p logs
set -euo pipefail
PY=/global/home/users/tbellg/miniforge3/envs/hapfm/bin/python
OUT_DIR=/global/scratch/users/tbellg/hapfire_sv/poolfreq/data/cn_full_231_v3qc_v3_mixedloose
mkdir -p $OUT_DIR
