#!/bin/bash
#SBATCH --job-name=cn_full_nomiss
#SBATCH --partition=bse
#SBATCH --cpus-per-task=4
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/logs/cn_full_nomiss_%A_%a.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/logs/cn_full_nomiss_%A_%a.err

# Build cn_full_231_v3qc_nomiss for one chrom from the no-missing VCF.
...
VCF=$BASE/pangenie_genotyping/data/v3qc/founders_231_v3qc.nomiss.haploid.vcf.gz
REF=/home/tbellagio/scratch/pang/pang_1001gplus/20260209_Exposito-Alonso/chr_only/TAIR10.chr.iupacN.fa
OUT_DIR=$BASE/poolfreq/data/cn_full_231_v3qc_nomiss
...
echo "[$(date)] $CHR: build cn_full_v3qc_nomiss"
