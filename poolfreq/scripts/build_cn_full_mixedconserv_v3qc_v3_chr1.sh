...
#SBATCH --mem=48G
#SBATCH --time=1:00:00
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/logs/mixcons_v3_%j.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/logs/mixcons_v3_%j.err
# Subset cn_full_v3qc_v3 to k-mers carried by ≥10 cactus + ≥10 PG founder.
set -euo pipefail
PY=/home/tbellagio/miniforge3/envs/hapfm/bin/python
OUT_DIR=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/data/cn_full_231_v3qc_v3_mixedconserv
mkdir -p $OUT_DIR
