...
#SBATCH --mem=80G
#SBATCH --time=2:00:00
#SBATCH --output=logs/sm_v3_ml_%j.out
#SBATCH --error=logs/sm_v3_ml_%j.err
# SEEDMIX_S1 cactus_em on v3qc_v3 mixed-loose Chr1, NEW cn_var with called mask.
#
# Reads source (UPDATED 2026-05-20):
#   /global/scratch/users/tbellg/pang/grenenet_reads/seed_mix_trimdedup/  ← trim+clumpify (jobB1)
...
#   Previous (trim-only, no dedup): /global/scratch/users/tbellg/pang/grenenet_reads/seed_mix/
