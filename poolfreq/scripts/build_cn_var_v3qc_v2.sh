...
#SBATCH --mem=128G
#SBATCH --time=2:00:00
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/logs/cn_var_v3qc_v2_%j.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/logs/cn_var_v3qc_v2_%j.err
set -euo pipefail
...
OUT_PREFIX=$BASE/poolfreq/data/cn_var_231_v3qc_v2
