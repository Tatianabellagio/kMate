...
#SBATCH --mem=32G
#SBATCH --time=4:00:00
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/tests/logs/chr1_sim_%j.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/tests/logs/chr1_sim_%j.err
...
FOUNDER_LIST=$(awk 'NR>1 {print $1}' /home/tbellagio/scratch/pang/pang_1001gplus/pang/seqfile.txt | paste -sd,)
N_FOUNDERS=$(awk 'NR>1' /home/tbellagio/scratch/pang/pang_1001gplus/pang/seqfile.txt | wc -l)
...
/home/tbellagio/miniforge3/envs/hapfm/bin/python tests/test_simulation_e2e.py
