...
#SBATCH --mem=128G
#SBATCH --time=4:00:00
#SBATCH --output=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/tests/logs/visor_%j.out
#SBATCH --error=/carnegie/nobackup/scratch/tbellagio/hapfire_sv/poolfreq/tests/logs/visor_%j.err
...
do
    set -- $COMBO
    REP=$1; COV=$2; FREQ=$3
    READS=/home/tbellagio/scratch/visor_freqk/data/reads_var/del/${REP}/${COV}/var_del_1kb_n231_${FREQ}_err001/all.fq
